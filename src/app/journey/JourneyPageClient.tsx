...
interface JourneyPageClientProps {
  journey: JourneyEntryData[];
}

export default function JourneyPageClient({ journey }: JourneyPageClientProps) {
  return (
        ...
        <div className="max-w-3xl mb-16 md:mb-20">
          ...
          <FadeIn delay={0.2}>
            <p className="mt-6 text-base md:text-lg text-[var(--color-text-secondary)] leading-relaxed max-w-2xl">
              Not a resume timeline — a continuous path of experiments, builds, and discoveries.
            </p>
          </FadeIn>
        </div>
                  ...
                  <div className="flex gap-6 md:gap-8">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline gap-3">
                        <span className="text-xs font-mono text-[var(--color-text-muted)] tracking-wider">{entry.year}</span>
                        <h3 className="text-xl md:text-2xl font-medium text-[var(--color-text-primary)]">{entry.title}</h3>
                      </div>
                      <p className="mt-3 text-sm md:text-base text-[var(--color-text-secondary)] leading-relaxed max-w-lg">{entry.description}</p>
